...
export function blankCard(deck:Deck):Card {return {id:crypto.randomUUID(),deckId:deck.id,front:blankSide(deck.language),back:blankSide('pt-BR',true),version:0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),archived:false,deleted:false}}
